...
大多数应用需要创建和使用应用内购买（In App Purchases）来产生收入并启用升级功能。为您的 Capacitor 应用添加应用内购买支持是直接了当的，但需要投入相当多的工作来配置和注册您自己的应用产品。
...
在 Capacitor 应用中设置应用内购买的大部分工作，在于为 iOS 和 Android 注册您的产品和消耗品，然后在应用中设置正确的流程来注册和使用这些项目。
