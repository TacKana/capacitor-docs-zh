...
description: Clipboard API 支持从系统剪贴板复制和粘贴。
...
| **`image`**        | <code>string</code> | 要复制的 [Data URL](https://developer.mozilla.org/en-US/docs/v3/Web/HTTP/Basics_of_HTTP/Data_URIs) 格式的图像。 | 1.0.0   |
