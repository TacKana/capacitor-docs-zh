...
在 Capacitor 应用中使用 React 的开发者可以使用一组有用的、社区维护的 React Hooks，在 React 函数组件中访问 Capacitor API。
...
查看 [@capacitor-community/react-hooks](https://github.com/capacitor-community/react-hooks) 仓库以获取所有可用 hooks 的文档。
