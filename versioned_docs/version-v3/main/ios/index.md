...
支持 iOS 12+。需要 Xcode 12+（请参阅[环境设置](/main/getting-started/environment-setup.md#ios-开发)）。Capacitor 使用 [WKWebView](https://developer.apple.com/documentation/webkit/wkwebview)，而不是已弃用的 [UIWebView](https://developer.apple.com/documentation/uikit/uiwebview)。
