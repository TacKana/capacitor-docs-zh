...
大多数应用需要创建和使用应用内购买功能来创收并支持升级。在您的 Capacitor 应用中添加应用内购买支持是直接的，但需要大量工作来配置和注册您自己的应用内产品。
...
在 Capacitor 应用中设置应用内购买的大部分工作在于为 iOS 和 Android 注册您的产品和消耗品，然后在您的应用中设置适当的流程来注册和使用这些项目。
