...
支持 iOS 13+。需要 Xcode 15.0+（请参阅[环境设置](/main/getting-started/environment-setup.md#ios-要求)）。Capacitor 使用 [WKWebView](https://developer.apple.com/documentation/webkit/wkwebview)，而非已弃用的 [UIWebView](https://developer.apple.com/documentation/uikit/uiwebview)。
