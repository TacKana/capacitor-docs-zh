---
title: 屏幕方向
description: 管理您的 Capacitor 应用中的屏幕方向设置
contributors:
  - mlynch
...
在 Android 上，可以通过修改 `AndroidManifest.xml` 并在主应用 Activity 的 `<activity>` 条目上设置 `android:screenOrientation` 来设置方向。请参阅 [Android Manifest 文档](https://developer.android.com/guide/topics/manifest/activity-element#screen) 了解可能的条目详情。
...
查看[方向插件文档](https://capacitorjs.com/docs/apis/screen-orientation)了解全部可能的方向值和配置选项。
