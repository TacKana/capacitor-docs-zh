...
description: Toast API 提供通知弹窗，用于向用户显示重要信息。就像真正的吐司一样！
...
Toast API 提供通知弹窗，用于向用户显示重要信息。就像真正的吐司一样！
...
| **`duration`**   | <code>'short' \| 'long'</code>             | Toast 的持续时间，可以是 'short'（2000 毫秒）或 'long'（3500 毫秒）                | <code>'short'</code>  | 1.0.0 |
