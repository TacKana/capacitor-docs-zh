...
默认情况下，使用原生库修补 `window.fetch` 和 `XMLHttpRequest` 的功能是禁用的。
...
由于桥接机制的特性，从原生端解析和传输大量数据到 Web 可能会导致问题。计划在不久的将来在 `@capacitor/filesystem` 插件中添加对下载和上传文件到原生设备的支持。在此期间，解决内存不足问题的一种可能方法（特别是在 Android 上）是编辑 `AndroidManifest.xml` 并在 `application` 元素中添加 `android:largeHeap="true"`。大多数应用不需要这样做，而应该专注于减少整体内存使用以提高性能。启用此功能也不能保证可用内存的固定增加，因为某些设备受其总可用内存的限制。
...
| 属性            | 类型                                                  | 描述                               |
| --------------- | ----------------------------------------------------- | ---------------------------------- |
| **`data`**      | <code>any</code>                                      | 伴随 HTTP 响应接收的额外数据。     |
...
| **`data`**                    | <code>any</code>                                                | 注意：在 Android 和 iOS 上，data 只能是字符串或 JSON。FormData、<a href="#blob">Blob</a>、<a href="#arraybuffer">ArrayBuffer</a> 和其他复杂类型仅在 Web 上直接支持，或通过在配置中启用 `CapacitorHttp` 并使用修补后的 `window.fetch` 或 `XMLHttpRequest` 来支持。如果您需要发送复杂类型，应将数据序列化为 base64 并相应设置 `headers["Content-Type"]` 和 `dataType` 属性。                                                                                                                          |
| **`headers`**                 | <code><a href="#httpheaders">HttpHeaders</a></code>             | 随请求发送的 HTTP 请求标头。                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **`readTimeout`**             | <code>number</code>                                             | 等待读取额外数据的时间（毫秒）。每次收到新数据时重置。                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **`connectTimeout`**          | <code>number</code>                                             | 等待初始连接的时间（毫秒）。                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| **`disableRedirects`**        | <code>boolean</code>                                            | 设置是否禁用自动 HTTP 重定向。                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **`webFetchExtra`**           | <code><a href="#requestinit">RequestInit</a></code>             | 在 Web 上运行时，fetch 的额外参数。                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **`responseType`**            | <code><a href="#httpresponsetype">HttpResponseType</a></code>   | 用于在返回给请求者之前适当解析响应。如果响应 content-type 是 "json"，则忽略此值。                                                                                                                                                                                                                                                                                                                                                                                                                 |
| **`shouldEncodeUrlParams`**   | <code>boolean</code>                                            | 在某些情况下，如果您需要保持 URL 不编码（已编码、azure/firebase 测试等），请使用此选项。默认值为 true。                                                                                                                                                                                                                                                                                                                                                                                           |
| **`dataType`**                | <code>'file' \| 'formData'</code>                               | 如果我们需要将数据从需要在原生层特殊处理的 JS 类型转换过来时使用。                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| 属性                   | 类型                                                                | 描述                                                                                                                                                                             |
| ---------------------- | ------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`body`**             | <code><a href="#bodyinit">BodyInit</a></code>                       | BodyInit 对象或 null，用于设置请求的 body。                                                                                                                                      |
| **`cache`**            | <code><a href="#requestcache">RequestCache</a></code>               | 指示请求如何与浏览器缓存交互的字符串，用于设置请求的 cache。                                                                                                                     |
| **`credentials`**      | <code><a href="#requestcredentials">RequestCredentials</a></code>   | 指示是否始终、从不或仅在同源 URL 时发送凭据的字符串。设置请求的 credentials。                                                                                                   |
| **`headers`**          | <code><a href="#headersinit">HeadersInit</a></code>                 | Headers 对象、对象字面量或二元数组的数组，用于设置请求的 headers。                                                                                                               |
| **`integrity`**        | <code>string</code>                                                 | 要获取的资源的加密哈希值。设置请求的 integrity。                                                                                                                                 |
| **`keepalive`**        | <code>boolean</code>                                                | 设置请求的 keepalive 的布尔值。                                                                                                                                                  |
| **`method`**           | <code>string</code>                                                 | 设置请求方法的字符串。                                                                                                                                                           |
| **`mode`**             | <code><a href="#requestmode">RequestMode</a></code>                 | 指示请求是否使用 CORS，或限制为同源 URL 的字符串。设置请求的 mode。                                                                                                              |
| **`redirect`**         | <code><a href="#requestredirect">RequestRedirect</a></code>         | 指示请求是否遵循重定向、遇到重定向时产生错误、或返回重定向的字符串。设置请求的 redirect。                                                                                        |
| **`referrer`**         | <code>string</code>                                                 | 值为同源 URL、"about:client" 或空字符串，设置请求的 referrer。                                                                                                                   |
| **`referrerPolicy`**   | <code><a href="#referrerpolicy">ReferrerPolicy</a></code>           | 设置请求的 referrerPolicy 的引用者策略。                                                                                                                                          |
| **`signal`**           | <code><a href="#abortsignal">AbortSignal</a></code>                 | 设置请求的 signal 的 AbortSignal。                                                                                                                                                |
| **`window`**           | <code>any</code>                                                    | 只能为 null。用于解除请求与任何 Window 的关联。                                                                                                                                  |


#### Blob

一个不可变的原始数据的类文件对象。Blob 表示不一定采用 JavaScript 原生格式的数据。<a href="#file">File</a> 接口基于 <a href="#blob">Blob</a>，继承 blob 功能并扩展以支持用户系统上的文件。
...
表示二进制数据的原始缓冲区，用于为不同类型的类型化数组存储数据。ArrayBuffer 不能被直接读取或写入，
但可以传递给类型化数组或 DataView 对象来按需解释原始缓冲区。
...
| 方法      | 签名                                                                     | 描述                                                           |
| --------- | ------------------------------------------------------------------------ | -------------------------------------------------------------- |
| **slice** | (begin: number, end?: number) =&gt; <a href="#arraybuffer">ArrayBuffer</a> | 返回 <a href="#arraybuffer">ArrayBuffer</a> 的一部分。        |


#### ReadableStream

此 Streams API 接口表示可读取的字节数据流。Fetch API 通过 Response 对象的 body 属性提供了 <a href="#readablestream">ReadableStream</a> 的具体实例。
...
| **`writable`**   | <code><a href="#writablestream">WritableStream</a>&lt;W&gt;</code>   | 提供了一种方便的、可链式调用的方式，将此可读流通过转换流（或任何其他 { writable, readable } 对）进行管道传输。它简单地将流管道传输到提供的对的可写端，并返回可读端以供进一步使用。管道传输流将在传输期间锁定它，防止任何其他消费者获取读取器。                                                       |


#### WritableStream

此 Streams API 接口提供了将流数据写入目标（称为接收器）的标准抽象。此对象内置了背压和排队功能。
...
此 Streams API 接口是由 <a href="#writablestream">WritableStream.getWriter</a>() 返回的对象，创建后将锁定编写器到 <a href="#writablestream">WritableStream</a>，确保没有其他流可以写入底层接收器。
...
| **`preventClose`**    | <code>boolean</code>                                  | 将此可读流管道传输到给定的可写流目标。管道传输过程中的各种错误条件下的行为可以通过多个传递选项进行自定义。它返回一个 promise，当管道传输过程成功完成时 fulfilled，如果遇到任何错误则 rejected。管道传输流将在传输期间锁定它，防止任何其他消费者获取读取器。源流和目标流的错误和关闭按如下方式传播：此源可读流中的错误将中止目标流，除非 preventAbort 为 truthy。返回的 promise 将以源错误或中止目标流时发生的任何错误被 rejected。目标流中的错误将取消此源可读流，除非 preventCancel 为 truthy。返回的 promise 将以目标错误或取消源时发生的任何错误被 rejected。当此源可读流关闭时，目标流将被关闭，除非 preventClose 为 truthy。返回的 promise 将在此过程完成后 fulfilled，除非在关闭目标流时遇到错误，在这种情况下将以该错误被 rejected。如果目标流开始时就已关闭或正在关闭，此源可读流将被取消，除非 preventCancel 为 true。返回的 promise 将以指示管道传输到已关闭流失败的错误被 rejected，或取消源时发生的任何错误。signal 选项可以设置为 <a href="#abortsignal">AbortSignal</a>，以允许通过相应的 AbortController 中止正在进行的管道操作。在这种情况下，此源可读流将被取消，目标流将被中止，除非相应的 preventCancel 或 preventAbort 选项被设置。 |
...
| 方法                        | 签名                                                                                                                                                                                                                              | 描述                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| --------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **addEventListener**        | &lt;K extends "abort"&gt;(type: K, listener: (this: <a href="#abortsignal">AbortSignal</a>, ev: AbortSignalEventMap[K]) =&gt; any, options?: boolean \| <a href="#addeventlisteneroptions">AddEventListenerOptions</a>) =&gt; void | 为类型属性值为 type 的事件追加事件监听器。callback 参数设置事件派发时将调用的回调。options 参数设置监听器特定的选项。为兼容性，这可以是一个布尔值，在这种情况下方法的行为与将值指定为 options 的 capture 完全相同。当设置为 true 时，options 的 capture 阻止 callback 在事件的 eventPhase 属性值为 BUBBLING_PHASE 时被调用。当为 false（或不存在）时，callback 不会在事件 eventPhase 属性值为 CAPTURING_PHASE 时被调用。无论哪种方式，如果事件的 eventPhase 属性值为 AT_TARGET，callback 都将被调用。当设置为 true 时，options 的 passive 指示 callback 不会通过调用 preventDefault() 来取消事件。这用于启用 § 2.8 观察事件监听器中描述的性能优化。当设置为 true 时，options 的 once 指示 callback 只会被调用一次，之后事件监听器将被移除。事件监听器被追加到目标的 event listener list，如果它具有相同的 type、callback 和 capture，则不会被追加。 |
| **addEventListener**        | (type: string, listener: <a href="#eventlisteneroreventlistenerobject">EventListenerOrEventListenerObject</a>, options?: boolean \| <a href="#addeventlisteneroptions">AddEventListenerOptions</a>) =&gt; void                    | 为类型属性值为 type 的事件追加事件监听器。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **removeEventListener**     | &lt;K extends "abort"&gt;(type: K, listener: (this: <a href="#abortsignal">AbortSignal</a>, ev: AbortSignalEventMap[K]) =&gt; any, options?: boolean \| <a href="#eventlisteneroptions">EventListenerOptions</a>) =&gt; void      | 移除目标 event listener list 中具有相同 type、callback 和 options 的事件监听器。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **removeEventListener**     | (type: string, listener: <a href="#eventlisteneroreventlistenerobject">EventListenerOrEventListenerObject</a>, options?: boolean \| <a href="#eventlisteneroptions">EventListenerOptions</a>) =&gt; void                          | 移除目标 event listener list 中具有相同 type、callback 和 options 的事件监听器。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| **`cancelable`**         | <code>boolean</code>                                  | 根据事件初始化方式返回 true 或 false。其返回值并不总是有意义，但 true 可以指示事件分派期间的操作部分可以通过调用 preventDefault() 方法取消。                                                                                                        |
| **`composed`**           | <code>boolean</code>                                  | 根据事件初始化方式返回 true 或 false。如果事件调用了经过其目标的根节点的 ShadowRoot 节点的监听器，则为 true，否则为 false。                                                                                                                        |
| **`currentTarget`**      | <code><a href="#eventtarget">EventTarget</a></code>   | 返回其事件监听器的回调当前正在被调用的对象。                                                                                                                                                                                                      |
...
| **`timeStamp`**          | <code>number</code>                                   | 返回事件的时间戳，以相对于时间原点测量的毫秒数表示。                                                                                                                                                                                               |
...
| 方法                         | 签名                                                            | 描述                                                                                                                                                                                                                           |
| ---------------------------- | --------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **composedPath**             | () =&gt; EventTarget[]                                          | 返回事件路径的调用目标对象列表（将调用监听器的对象），但不包括影子树中的节点（其影子根的模式为 "closed"）且从事件的 currentTarget 不可达的节点。                                                                               |
| **initEvent**                | (type: string, bubbles?: boolean, cancelable?: boolean) =&gt; void |                                                                                                                                                                                                                                |
| **preventDefault**           | () =&gt; void                                                   | 如果在 cancelable 属性值为 true 时调用，并且在执行 passive 设置为 false 的事件监听器时，向导致事件分派的操作发出信号，表明需要取消它。                                                                                         |
| **stopImmediatePropagation** | () =&gt; void                                                   | 调用此方法可防止事件在当前监听器完成运行后到达任何已注册的事件监听器，并且在树中分派时，还防止事件到达任何其他对象。                                                                                                            |
| **stopPropagation**          | () =&gt; void                                                   | 在树中分派时，调用此方法可防止事件到达当前对象以外的任何对象。                                                                                                                                                               |


#### EventTarget

<a href="#eventtarget">EventTarget</a> 是一个 DOM 接口，由可以接收事件并且可能具有事件监听器的对象实现。
EventTarget 是一个 DOM 接口，由可以接收事件并且可能具有事件监听器的对象实现。
...
| **dispatchEvent**           | (event: <a href="#event">Event</a>) =&gt; boolean                                                                                                                                                                   | 向目标分派一个合成事件 event，如果事件的 cancelable 属性值为 false 或其 preventDefault() 方法未被调用，则返回 true，否则返回 false。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| **removeEventListener**     | (type: string, callback: <a href="#eventlisteneroreventlistenerobject">EventListenerOrEventListenerObject</a> \| null, options?: <a href="#eventlisteneroptions">EventListenerOptions</a> \| boolean) =&gt; void     | 移除目标 event listener list 中具有相同 type、callback 和 options 的事件监听器。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
<a href="#arraybufferview">ArrayBufferView</a> 和相关类型化数组的缓冲区的允许 <a href="#arraybuffer">ArrayBuffer</a> 类型。
...
提供了一种简单的方法来构建表示表单字段及其值的键/值对集合，然后可以使用 XMLHttpRequest.send() 方法轻松发送。它使用的格式与编码类型设置为 "multipart/form-data" 时表单使用的格式相同。
...
| 方法               | 签名                                                                                                                                                                        | 描述                                                                                                                                                                                                                                      |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **copyWithin**     | (target: number, start: number, end?: number) =&gt; this                                                                                                                     | 返回将此对象通过将 start 和 end 标识的数组部分复制到同一数组中位置 target 后得到的对象。                                                                                                                                                   |
...
| **fill**           | (value: number, start?: number, end?: number) =&gt; this                                                                                                                     | 通过用值填充 start 和 end 标识的部分来返回此对象。                                                                                                                                                                                        |
...
| **find**           | (predicate: (value: number, index: number, obj: <a href="#uint8array">Uint8Array</a>) =&gt; boolean, thisArg?: any) =&gt; number \| undefined                                | 返回数组中 predicate 为 true 的第一个元素的值，否则返回 undefined。                                                                                                                                                                       |
| **findIndex**      | (predicate: (value: number, index: number, obj: <a href="#uint8array">Uint8Array</a>) =&gt; boolean, thisArg?: any) =&gt; number                                             | 返回数组中 predicate 为 true 的第一个元素的索引，否则返回 -1。                                                                                                                                                                            |
| **forEach**        | (callbackfn: (value: number, index: number, array: <a href="#uint8array">Uint8Array</a>) =&gt; void, thisArg?: any) =&gt; void                                               | 为数组中的每个元素执行指定操作。                                                                                                                                                                                                         |
| **indexOf**        | (searchElement: number, fromIndex?: number) =&gt; number                                                                                                                     | 返回数组中第一次出现值的索引。                                                                                                                                                                                                           |
| **join**           | (separator?: string) =&gt; string                                                                                                                                            | 使用指定的分隔符字符串将所有数组元素连接起来。                                                                                                                                                                                            |
...
| **reduce**         | (callbackfn: (previousValue: number, currentValue: number, currentIndex: number, array: <a href="#uint8array">Uint8Array</a>) =&gt; number) =&gt; number                     | 为数组中的所有元素调用指定的回调函数。回调函数的返回值是累积的结果，并在下次调用回调函数时作为参数提供。                                                                                                                                |
...
| **reduce**         | &lt;U&gt;(callbackfn: (previousValue: U, currentValue: number, currentIndex: number, array: <a href="#uint8array">Uint8Array</a>) =&gt; U, initialValue: U) =&gt; U          | 为数组中的所有元素调用指定的回调函数。回调函数的返回值是累积的结果，并在下次调用回调函数时作为参数提供。                                                                                                                                |
| **reduceRight**    | (callbackfn: (previousValue: number, currentValue: number, currentIndex: number, array: <a href="#uint8array">Uint8Array</a>) =&gt; number) =&gt; number                     | 以降序为数组中的所有元素调用指定的回调函数。回调函数的返回值是累积的结果，并在下次调用回调函数时作为参数提供。                                                                                                                            |
...
| **reduceRight**    | &lt;U&gt;(callbackfn: (previousValue: U, currentValue: number, currentIndex: number, array: <a href="#uint8array">Uint8Array</a>) =&gt; U, initialValue: U) =&gt; U          | 以降序为数组中的所有元素调用指定的回调函数。回调函数的返回值是累积的结果，并在下次调用回调函数时作为参数提供。                                                                                                                            |
...
此 Fetch API 接口允许您对 HTTP 请求和响应标头执行各种操作。这些操作包括获取、设置、添加和删除。Headers 对象有一个关联的 header list，初始为空，由零个或多个名称和值对组成。您可以使用 append() 等方法添加（参见示例。）在此接口的所有方法中，标头名称按不区分大小写的字节序列匹配。
