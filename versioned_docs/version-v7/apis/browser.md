...
description: Browser API 提供了打开应用内浏览器并订阅浏览器事件的能力。
custom_edit_url: https://github.com/ionic-team/capacitor-plugins/blob/7.x/browser/README.md
...
Browser API 提供了打开应用内浏览器并订阅浏览器事件的能力。

在 iOS 上，它使用 `SFSafariViewController`，并且符合主流 OAuth 服务对应用内浏览器的要求。
...
- `androidxBrowserVersion`: `androidx.browser:browser` 的版本 (默认值：`1.8.0`)
...
| **`width`**             | <code>number</code>                    | 仅限 iOS：在 iPad 上使用 presentationStyle 'popover' 时浏览器的宽度。在其他平台上忽略。                                               | 4.0.0 |
| **`height`**            | <code>number</code>                    | 仅限 iOS：在 iPad 上使用 presentationStyle 'popover' 时浏览器的高度。在其他平台上忽略。                                              | 4.0.0 |
