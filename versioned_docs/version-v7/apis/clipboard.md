...
description: Clipboard API 支持从系统剪贴板复制和粘贴数据。
custom_edit_url: https://github.com/ionic-team/capacitor-plugins/blob/7.x/clipboard/README.md
...
| **`image`**  | <code>string</code> | 要复制的图片，使用 [Data URL](https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/Data_URIs) 格式。 | 1.0.0 |
