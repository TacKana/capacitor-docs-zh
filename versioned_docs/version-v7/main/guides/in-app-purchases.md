...
大多数应用需要创建和使用应用内购买功能来创收并支持升级。为您的 Capacitor 应用添加应用内购买支持相对直接，但需要投入大量工作来配置和注册您自己的应用产品。
...
在 Capacitor 应用中设置应用内购买的主要工作量在于为 iOS 和 Android 注册您的产品和消耗品，然后在应用中建立正确的流程来注册和使用这些项目。

这是一个相当复杂的过程，我们建议您参考以下指南作为下一步：
