...
:::info
你也可以[通过 Xcode 在 iOS 上运行应用](/main/ios/index.md#running-in-xcode) 或[通过 Android Studio 在 Android 上运行应用](/main/android/index.md#running-with-android-studio)。这两种方式都适用于开发。可以都尝试一下，看看你更喜欢哪种方式！
:::
...
打开原生项目可以让你完全控制应用的原生运行时。你可以[创建插件](/plugins.mdx)、[添加自定义原生代码](/main/ios/custom-code.md)或[编译应用](#compiling-your-native-binary)以进行发布。
