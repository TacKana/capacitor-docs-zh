...
大多数应用需要创建和使用应用内购买以产生收入和实现升级。为您的 Capacitor 应用添加应用内购买支持很简单，但需要相当多的配置和注册您自己的应用产品的工作。
...
在 Capacitor 应用中设置应用内购买的大部分工作来自为 iOS 和 Android 注册您的产品和消耗品，然后设置适当的流程来在您的应用中注册和使用这些项目。
