...
## Android 12+
在 Android 12 及以上版本中，Google 更改了启动屏的显示方式，使用带有彩色背景的较小图标，而不是 Android 11 及以下版本支持的全屏图像。有关此更改的更多文档，请访问 [developer.android.com](https://developer.android.com/develop/ui/views/launch/splash-screen)。
