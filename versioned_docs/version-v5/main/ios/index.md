...
支持 iOS 13+。需要 Xcode 14.1+（请参阅[环境设置](/main/getting-started/environment-setup.md#ios-requirements)）。Capacitor 使用 [WKWebView](https://developer.apple.com/documentation/webkit/wkwebview)，而不是已废弃的 [UIWebView](https://developer.apple.com/documentation/uikit/uiwebview)。
