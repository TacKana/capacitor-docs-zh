...
description: Clipboard API 支持与系统剪贴板之间的复制和粘贴操作。
...
Clipboard API 支持与系统剪贴板之间的复制和粘贴操作。
...
| **`image`**  | <code>string</code> | 要复制的图像，格式为 [Data URL](https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/Data_URIs)。 | 1.0.0 |
