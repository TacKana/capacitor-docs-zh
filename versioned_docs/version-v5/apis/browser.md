...
| **`presentationStyle`** | <code>'fullscreen' \| 'popover'</code>| 仅 iOS：浏览器的展示样式。默认为全屏。在其他平台上被忽略。                                                                       | 1.0.0 |
| **`width`**             | <code>number</code>                  | 仅 iOS：在 iPad 上使用 'popover' 展示样式时浏览器的宽度。在其他平台上被忽略。                                                     | 4.0.0 |
| **`height`**            | <code>number</code>                  | 仅 iOS：在 iPad 上使用 'popover' 展示样式时浏览器的高度。在其他平台上被忽略。                                                     | 4.0.0 |
