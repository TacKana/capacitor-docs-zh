...
支持 iOS 15+ 系统。需要 Xcode 26.0+ 版本（参见[环境设置](/main/getting-started/environment-setup.md#ios-requirements)）。Capacitor 使用 [WKWebView](https://developer.apple.com/documentation/webkit/wkwebview)，而非已弃用的 [UIWebView](https://developer.apple.com/documentation/uikit/uiwebview)。
...
要在无线 iOS 设备上运行应用，请确保您的设备已与“访达”（Finder）配对，并勾选“Wi-Fi 状态下显示此 iPhone”选项：
