...
要修改它，[在 Xcode 中打开您的项目](/main/ios/index.md#opening-the-ios-project)，选择 **App** 项目和 **App** target，然后点击 **Info** 标签页。
...
要添加新的 capability，[在 Xcode 中打开您的应用](/main/ios/index.md#opening-the-ios-project)，选择 **App** 项目和 **App** target，在标签栏中点击 **Signing & Capabilities**，然后点击 **+ Capability** 按钮。请参阅[这篇文章](https://developer.apple.com/documentation/xcode/adding_capabilities_to_your_app)了解有关 iOS capabilities 的更多信息。
