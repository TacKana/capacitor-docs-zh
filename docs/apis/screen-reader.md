...
description: Screen Reader API 提供对 TalkBack/VoiceOver 等屏幕阅读器的访问权限，并为视觉辅助功能提供简单的文本转语音能力。
...
Screen Reader API 提供对 TalkBack/VoiceOver 等屏幕阅读器的访问权限，并为视觉辅助功能提供简单的文本转语音能力。
...
| **`language`** | <code>string</code> | 朗读文本所使用的语言，采用其 [ISO 639-1 代码](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)（例如："en"）。此选项仅在 Android 上受支持。 | 1.0.0 |
