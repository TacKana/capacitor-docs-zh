...
custom_edit_url: https://github.com/ionic-team/capacitor-plugins/blob/next/device/README.md
...
| 属性                      | 类型                                                          | 描述                                                                                                                                                                                                                                                                                                                                        | Since |
| ------------------------- | ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
| **`name`**                | <code>string</code>                                           | 设备的名称。例如，"John's iPhone"。仅在 iOS 和 Android 支持。在 iOS 16+ 上，如果没有适当的[授权](https://developer.apple.com/documentation/bundleresources/entitlements/com_apple_developer_device-information_user-assigned-device-name)，将返回通用设备名称。                                                             | 1.0.0 |
