...
description: Text Zoom API 提供了调整 Web View 文本大小的功能，以增强视觉可访问性。
...
Text Zoom API 提供了调整 Web View 文本大小的功能，以增强视觉可访问性。

**注意：** 除非您在 [Capacitor 配置文件](https://capacitorjs.com/docs/config) 中将 `preferredContentMode` 配置设置为 `mobile`，否则 text-zoom 插件在 iPad 上将无法工作。
...
| 属性          | 类型                | 描述                                          | 起始版本 |
| ----------- | ------------------- | ---------------------------------------------- | ----- |
| **`value`** | <code>number</code> | 当前的缩放级别（以小数形式表示）。 | 1.0.0 |
...
| 属性          | 类型                | 描述                                            | 起始版本 |
| ----------- | ------------------- | ------------------------------------------------ | ----- |
| **`value`** | <code>number</code> | 首选的缩放级别（以小数形式表示）。 | 1.0.0 |
...
| 属性          | 类型                | 描述                                    | 起始版本 |
| ----------- | ------------------- | ---------------------------------------- | ----- |
| **`value`** | <code>number</code> | 新的缩放级别（以小数形式表示）。 | 1.0.0 |
